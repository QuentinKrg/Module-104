...
public class GestionSousCategories extends javax.swing.JFrame {
    ...
    private static final String CHAINE_MOTS_ERREUR = "MIN & MAX 4 chiffres pour le bureau";
    ...
    private void jTextField1_Nom_Sous_CategorieKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1_Nom_Sous_CategorieKeyReleased
        ...
        String expression = "[1-9][1-9][1-9][1-9]";
    ...
    private boolean ajouter_sous_categorie(String NomSousCategorie) {
        ...
        String sql_insert_sc = "INSERT INTO t_emplacement (Batiment_empl, NumBureau_empl) VALUES ('',?);";
        //SELECT * FROM `t_sous_categorie` WHERE `Nom_Sous_Categorie` LIKE '%ni%' COLLATE utf8mb4_unicode_ci
        String sql_select_doublon = "SELECT *  FROM t_emplacement WHERE NumBureau_empl COLLATE utf8_unicode_ci LIKE ?";
    ...
    private boolean remplir_table_sous_categories() {
      ...
      String sql_select_sc = "SELECT id_emplacement, NumBureau_empl COLLATE utf8_unicode_ci as NumBureau_empl  FROM t_emplacement ORDER BY NumBureau_empl COLLATE utf8_unicode_ci ASC";
        ...
        try{
            ...
            String entete_sous_categories[] = {"id","Bureau","Emplacement"};
            ...
            while(rs.next())
            {
                Object o[] = {rs.getInt("id_emplacement"),rs.getString("NumBureau_empl")};
    ...
    private boolean update_sous_categorie(String nomsouscategorie, int idsouscategorie) {
        ...
        String sql_select_doublon = "SELECT * FROM t_emplacement WHERE NumBureau_empl LIKE ?";
        String sql_update_sc = "UPDATE t_emplacement SET NumBureau_empl = ? WHERE id_emplacement = ?";              
        try{
            // OMDB 13.03.2018 : "préparer" la requête (ici sans paramètres) pour la BD.
            PreparedStatement pst = ConnectionBd.getConnection().prepareStatement(sql_select_doublon);
    ...
    private boolean delete_sous_categorie(int idsouscategorie) {
        ...
        String sql_delete_sc = "DELETE FROM t_emplacement WHERE id_emplacement = ?";
